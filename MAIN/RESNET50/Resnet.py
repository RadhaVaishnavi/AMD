...
def classify(Data,Label,tr,ACC,TPR,TNR):
    ...
    x_train, x_test, y_train, y_test = train_test_split(Data, Label, train_size=tr, random_state=0) #splliting train and test
    target = np.concatenate((y_train,y_test))

    # Setting Training Hyperparameters
    batch_size = 128
    epochs = 10         #Epoch is varried by changing the iteration value
